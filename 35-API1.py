...
resX = requests.get("https://cnn.com/")
print(resX)
print(" API Status ", resX.status_code)

resY = requests.get("https://reqres.in/api/users/23")
print("ReqRes.in status code is ", resY.status_code)
